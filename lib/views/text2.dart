...
class TextPayment extends StatefulWidget {
  @override
  _TextPaymentState createState() => _TextPaymentState();
}

class _TextPaymentState extends State<TextPayment> {
  String backendUrl = '{YOUR_BACKEND_URL}';
  String paystackPublicKey = '${dotenv.env['PAYSTACK_PUBLIC_KEY']}';
   String appName = 'Bulk Sms';
