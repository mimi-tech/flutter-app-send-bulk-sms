...
class NewPhoneNumberList extends StatefulWidget {
  const NewPhoneNumberList({Key? key}) : super(key: key);

  @override
  _NewPhoneNumberListState createState() => _NewPhoneNumberListState();
}

class _NewPhoneNumberListState extends State<NewPhoneNumberList> {
  @override
                    ...
                    children: [
                      Expanded(
                        child: ListView.builder(
                            ...
                            itemCount:modal.enteredContact.length,
                            shrinkWrap: true,
                            itemBuilder: (BuildContext ctxt, int index) {
                              return Padding(
                                  ...
                                  child:OutlinedButton.icon(
                                    ...
                                    onPressed: () {
                                      modal.removeEnteredContact(modal.enteredContact[index]);
                                    ...
                                    label: Text(modal.enteredContact[index],
                      ...
                      Material(
                        ...
                        child: Padding(
                          ...
                          child: Text("+ ${modal.enteredContact.length}".toString(),
